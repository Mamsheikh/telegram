...
const MenuBar: React.FC<MenuBarProps> = ({ show, setShow }) => {
  return (
    <>
      <div className='inset-y-0 left-0 z-10 absolute max-w-xs w-full bg-white shadow-md'>
        ...
        <div className='px-6 space-y-3'>
          <div className='flex items-center space-x-4 mt-4 hover:bg-gray-100 rounded p-2  cursor-pointer'>
